...
router.put("/profile-update", async (req, res) => {
  ...
  console.log("🔍 Backend - User profile update request:", { userId, updatedProfile });
  ...
  try {
    ...
    if (userId) {
      ...
      console.log("✅ Backend - User updated successfully:", updatedUser.userName || updatedUser.name);
