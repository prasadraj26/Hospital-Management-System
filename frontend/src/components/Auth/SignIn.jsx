        ...
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md bg-gradient-to-br from-purple-100 to-indigo-100 shadow-xl shadow-purple-200 p-4 rounded-lg border border-purple-200">
          ...
          <p className="mt-2 text-center text-sm text-purple-700">
            ...
            <Link
              to="/sign-up"
              title=""
              className="font-semibold text-purple-600 transition-all duration-200 hover:underline"
            >
          ...
          <form className="mt-8">
            <div className="space-y-5">
              <div>
                <label
                  htmlFor=""
                  className="text-base font-medium text-purple-800"
                >
                  {" "}
                  Email address{" "}
                </label>
                <div className="mt-2 border-purple-300 border-2 rounded-lg">
                  <input
                    className="flex h-10 w-full rounded-md border  outline-none border-none bg-transparent px-3 py-2 text-sm placeholder:text-purple-500  disabled:cursor-not-allowed disabled:opacity-50"
                    type="email"
                    placeholder="Email"
                    onChange={(e) =>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  type="button"
                  className="inline-flex w-full items-center justify-center rounded-md bg-gradient-to-r from-purple-500 to-purple-600 px-3.5 py-2.5 font-semibold leading-7 text-white hover:from-purple-600 hover:to-purple-700 shadow-lg transition-all duration-200"
                >
                  Get started
                </button>
              </div>
          ...
          <div className="mt-3 space-y-3">
            <button
              type="button"
              className="relative inline-flex w-full items-center justify-center rounded-md border border-purple-300 bg-gradient-to-r from-indigo-100 to-purple-100 px-3.5 py-2.5 font-semibold text-purple-700 transition-all duration-200 hover:from-indigo-200 hover:to-purple-200 hover:text-purple-800 focus:from-indigo-200 focus:to-purple-200 focus:text-purple-800 focus:outline-none shadow-lg"
            ...
            <button
              type="button"
              className="relative inline-flex w-full items-center justify-center rounded-md border border-purple-300 bg-gradient-to-r from-violet-100 to-purple-100 px-3.5 py-2.5 font-semibold text-purple-700 transition-all duration-200 hover:from-violet-200 hover:to-purple-200 hover:text-purple-800 focus:from-violet-200 focus:to-purple-200 focus:text-purple-800 focus:outline-none shadow-lg"
              onClick={handleNurse}
            >
              SignIn As Nurse
            </button>
