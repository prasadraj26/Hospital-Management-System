  ...
  return (
    ...
    <div className="flex flex-col gap-4 md:gap-8">
      ...
      <div className="flex flex-row md:flex-col items-center md:items-start w-full gap-2 overflow-x-auto md:overflow-x-visible pb-2 md:pb-0 scrollbar-none">
        <NavLink style={navLinkStyle} className={"whitespace-nowrap px-3 md:px-4 py-2 md:py-2.5 rounded-lg transition-all duration-200 text-xs md:text-sm"} to="/user-profile">
          Settings
        </NavLink>

        <NavLink style={navLinkStyle} className={"whitespace-nowrap px-3 md:px-4 py-2 md:py-2.5 rounded-lg transition-all duration-200 text-xs md:text-sm"} to="/user-appointments">
          History
        </NavLink>

        <NavLink style={navLinkStyle} className={"whitespace-nowrap px-3 md:px-4 py-2 md:py-2.5 rounded-lg transition-all duration-200 text-xs md:text-sm"} to="/user-book-appointment">
          Book Appointment
        </NavLink>

        <NavLink style={navLinkStyle} className={"whitespace-nowrap px-3 md:px-4 py-2 md:py-2.5 rounded-lg transition-all duration-200 text-xs md:text-sm"} to="/user-medication">
          Medication
        </NavLink>
      </div>
    </div>
