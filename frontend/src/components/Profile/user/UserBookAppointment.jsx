...
function UserBookAppointment() {
  ...
  const handleSubmit = async (e) => {
    ...
    const appointmentData = {
      patient: userData?.userName || "Unknown Patient",
      phone: mobileNumber,
      doctor: doctor,
    ...
    await axios
      .post('http://localhost:4451/api/appointment/add-appointment', appointmentData)
      .then((res) => {
        Swal.fire({
          title: "Success",
          icon: "success",
              ...
              <div className="flex flex-col w-[50%] justify-start">
                ...
                >
                  ...
                  {doctors && doctors.length > 0 ? doctors.map((doctor, index) => (
                    <option key={doctor._id || index} value={doctor._id}>
                      {doctor.name}
                    </option>
                  )) : (
