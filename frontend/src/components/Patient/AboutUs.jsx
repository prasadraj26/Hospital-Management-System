...
function AboutUs() {
  ...
  return (
    ...
    className='pt-[80px] bg-gradient-to-br from-purple-50 to-indigo-50'>    
      <motion.div
      ref={ref}
      initial={{ opacity: 0 }} 
    ...
    className=' bg-gradient-to-br from-purple-50 to-indigo-50 pt-5'>
    <motion.div
    ref={ref}
    initial={{ opacity: 0 }} 
    animate={{ opacity: inView ? 1 : 0 }} 
    ...
    className=' bg-gradient-to-br from-purple-50 to-indigo-50 lg:pt-5'>
    <motion.div ref={ref}
        initial={{ opacity: 0 }} 
        animate={{ opacity: inView ? 1 : 0 }} 
        transition={{ duration: 1.5 }}
    ...
    className='bg-gradient-to-br from-purple-50 to-indigo-50 '>
      ...
      className='max-w-7xl m-auto h-full flex flex-col justify-center items-center gap-3  '>
        ...
        <div className='absolute  w-[59%] h-full flex justify-between items-center pt-5'>
          <button 
          onClick={prevSlide}
          className='bg-gradient-to-r from-purple-500 to-purple-600 rounded-full p-1 ms-1 flex justify-center items-center hover:from-purple-600 hover:to-purple-700 transition-all duration-300'>
          ...
          <button 
          onClick={nextSlide}
          className='bg-gradient-to-r from-purple-500 to-purple-600 rounded-full p-1 me-2 flex justify-center items-center hover:from-purple-600 hover:to-purple-700 transition-all duration-300'>
